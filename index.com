...
<head>
  ...
  <title>pyment ryzzi shop</title>
  <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;500;700&display=swap" rel="stylesheet">
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body {
      font-family: 'Outfit', sans-serif;
      background: url('https://files.catbox.moe/h5qb65.jpg') no-repeat center center fixed;
...
<div id="welcome-message" class="welcome-message">
  <h1>HAII BRO PERKENALKAN NAMA SAYA RYZZI 🫶</h1>
  <p>ELAMAT DATANG DI WEBSITE PAYMENT BY RYZZI SHOP.</p>
...
<div id="main-content">
  ...
  <div class="qr">
    <img src="https://files.catbox.moe/h5qb65.jpg" />
  </div>
  ...
  <div class="collapsible-container">
    ...
    <div class="content">
      <img src="https://files.catbox.moe/5ak56j.jpg" id="qris-image" style="width: 200px; border-radius: 12px; cursor: pointer;" />
      <p>Gunakan aplikasi pembayaran untuk scan kode QR ini.</p>
    </div>
    
    <button class="collapsible">DANA</button>
    <div class="content">
      <p><strong>DANA:</strong> 085215097779</p>
      <p><strong>ATAS NAMA:</strong> Bes** Bu***</p>
    </div>

    <button class="collapsible">GOPAY</button>
    <div class="content">
      <p><strong>GOPAY:</strong> 085215097779</p>
      <p><strong>ATAS NAMA:</strong> LUPA WKWK,TF AJA/p>
    </div>
  </div>

  <div class="btn-group">
    <a href="https://wa.me/6285215097779<" class="btn-link" target="_blank">WhatsApp</a>
    <a href="https://t.me/Ryzziofficial" class="btn-link" target="_blank">Telegram</a>
...
<div class="fullscreen-qr hidden" id="fullscreen-qr">
  <img src="https://files.catbox.moe/5ak56j.jpg" alt="QRIS Fullscreen" />
</div>
